        ...
        if ($email && $password) {
            if (isLoginLockedOut()) {
                ...
                if ($user && password_verify($password, $user['password'])) {
                    ...
                    logAudit(0, 'Failed login attempt', 'LOGIN', 'users', null, null, null, 'WARNING', 'Invalid credentials for ' . $email);
...
<div class="login-wrapper">
    ...
    <div class="login-brand">
        <div class="login-brand-logo">
            <img src="assets/images/rs_logo.jpg" alt="RS Pharmacy" class="brand-logo-img" style="width:48px;height:48px;object-fit:contain;margin-right:10px;">
