...
<nav class="landing-nav">
    <a href="index.php" class="brand">
        <img src="assets/images/rs_logo.jpg" alt="RS Pharmacy" class="brand-logo-img" style="width:36px;height:36px;object-fit:contain;margin-right:8px;vertical-align:middle;">
            ...
            <div>
                ...
                <div style="margin-top:24px;display:flex;flex-direction:column;gap:16px;">
                    <div style="display:flex;gap:16px;align-items:center;">
                        ...
                        <div><div style="font-weight:600;font-size:14px;">Address</div><div style="font-size:13px;color:var(--gray);">ZONE 2, Pinamalayan, Philippines, 5208</div></div>
                    </div>
                    <div style="display:flex;gap:16px;align-items:center;">
...
<footer class="footer-section">
    <div class="footer-grid">
        <div class="footer-brand">
            <div style="display:flex;align-items:center;gap:10px;"><img src="assets/images/rs_logo.png" alt="RS Pharmacy" class="brand-logo-img" style="width:22px;height:22px;object-fit:contain;margin-right:6px;vertical-align:middle;"><span style="font-size:18px;font-weight:700;color:white;">RS Pharmacy</span></div>
